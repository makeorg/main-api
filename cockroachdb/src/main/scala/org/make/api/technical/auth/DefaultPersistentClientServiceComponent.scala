...
import org.make.api.technical.auth.DefaultPersistentClientServiceComponent.{
  GRANT_TYPE_SEPARATOR,
  PersistentClient,
  ROLE_SEPARATOR
}
...
object DefaultPersistentClientServiceComponent {
        ...
        withSQL {
          insert
            ...
            .namedValues(
              ...
              column.roles -> client.roles.map(_.value).mkString(ROLE_SEPARATOR),
