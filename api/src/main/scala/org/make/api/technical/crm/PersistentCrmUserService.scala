...
object PersistentCrmUser extends SQLSyntaxSupport[PersistentCrmUser] with ShortenedNames with StrictLogging {
  ...
  def apply(
    ...
    PersistentCrmUser(
      ...
      lastLanguageActivity = resultSet.stringOpt(resultName.lastLanguageActivity),
  ...
  def fromContactProperty(email: String, fullName: String, contactProperties: ContactProperties): PersistentCrmUser = {
    PersistentCrmUser(
      ...
      lastLanguageActivity = contactProperties.lastLanguageActivity,
...
case class PersistentCrmUser(userId: String,
  ...
  def toContactProperties(updatedAt: Option[String]): ContactProperties = {
    ContactProperties(
      ...
      lastLanguageActivity = this.lastLanguageActivity,
