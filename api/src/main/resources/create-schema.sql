...
INSERT INTO tag (slug, label, enabled) VALUES
    ...
    ('aides', e'aides', true),
    ('aides-subventions', e'aides & subventions', true),
    ...
    ('bio', e'bio', true),
    ('bouleversements-technologiques', e'bouleversements technologiques', true),
    ...
    ('conditions-de-travail', e'conditions de travail', true),
    ('conflits', e'conflits', true),
    ('conges-duree-du-travail', e'congés & durée du travail', true),
    ('conquete-spatiale', e'conquête spatiale', true),
    ...
    ('democratie',  e'démocratie', true),
    ('deradicalisation', e'déradicalisation', true),
    ('dessin', e'dessin', true),
    ('developpement', e'développement', true),
    ...
    ('efficacite-de-l-etat', e'efficacité de l\'Etat', true),
    ...
    ('entreprenariat', e'entreprenariat', true),
    ...
    ('fonctionnement-des-institutions', e'fonctionnement des institutions', true),
    ('formation', e'formation', true),
    ('fracture-numerique', e'fracture numérique', true),
    ('gafa', e'GAFA', true),
    ('gastronomie', e'gastronomie', true),
    ('gouvernance-mondiale', e'gouvernance-mondiale', true),
    ('guerres', e'guerres', true),
    ...
    ('politique-eco-regulation', e'politique éco & régulation', true),
    ('politique-monetaire', e'politique monétaire', true),
    ...
    ('recherche-innovation', e'recherche & innovation', true),
    ...
    ('sanctions', e'sanctions', true),
    ('sante', e'santé', true),
    ('sdf', e'SDF', true),
    ('secu', e'Sécu', true),
    ('sécurite', e'sécurité', true),
    ...
    ('solidarites', e'solidarités', true),
    ...
    ('vieillissement', e'vieillissement', true),
    ...
    ('medical-environment', e'medical environment', true),
    ...
    ('mutilations-harmful-traditions', e'mutilations & harmful traditions', true),
    ...
    ('mutilazioni-tradizioni-dannose', e'mutilazioni & tradizioni dannose', true),
    ...
    ('aggresisoni-fisiche', e'aggresisoni fisiche', true),
    ('lpae-prevention', e'prévention', true),
    ('lpae-repression', e'répression', true),
    ('lpae-curation', e'curation', true),
    ('lpae-democratie', e'démocratie', true),
    ('lpae-efficacite-de-l-etat', e'efficacité de l\'Etat', true),
    ('lpae-ecologie', e'écologie', true),
    ('lpae-agriculture', e'agriculture', true),
    ('lpae-pauvrete', e'pauvreté', true),
    ('lpae-chomage', e'chômage', true),
    ('lpae-conditions-de-travail', e'conditions de travail', true),
    ('lpae-finance', e'finance', true),
    ('lpae-entreprenariat', e'entreprenariat', true),
    ('lpae-recherche-innovation', e'recherche & innovation', true),
    ('lpae-bouleversements-technologiques', e'bouleversements technologiques', true),
    ('lpae-jeunesse', e'jeunesse', true),
    ('lpae-inegalites', e'inégalités', true),
    ('lpae-discriminations', e'discriminations', true),
    ('lpae-culture', e'culture', true),
    ('lpae-vieillissement', e'vieillissement', true),
    ('lpae-handicap', e'handicap', true),
    ('lpae-logement', e'logement', true),
    ('lpae-sante', e'santé', true),
    ('lpae-solidarites', e'solidarités', true),
    ('lpae-justice', e'justice', true),
    ('lpae-sécurite', e'sécurité', true),
    ('lpae-terrorisme', e'terrorisme', true),
    ('lpae-developpement', e'développement', true),
    ('lpae-guerres', e'guerres', true),
    ('lpae-ue', e'UE', true),
    ('lpae-gouvernance-mondiale', e'gouvernance mondiale', true),
    ('lpae-conquete-spatiale', e'conquête spatiale', true),
    ('lpae-politique-eco-regulation', e'politique éco & régulation', true),
    ('lpae-aides-subventions', e'aides & subventions', true),
    ('lpae-fiscalite', e'fiscalité', true),
    ('lpae-politique-monetaire', e'politique monétaire', true),
    ('lpae-couverture-sociale', e'couverture sociale', true),
    ('lpae-medical', e'médical', true),
    ('lpae-mobilites', e'mobilités', true),
    ('lpae-sensibilisation', e'sensibilisation', true),
    ('lpae-education', e'éducation', true),
    ('lpae-sanctions', e'sanctions', true),
    ('lpae-rse', e'RSE', true),
    ('lpae-nouvelles-technologies', e'nouvelles technologies', true),
    ('lpae-fonctionnement-des-institutions', e'fonctionnement des institutions', true),
    ('lpae-participation-citoyenne', e'participation citoyenne', true),
    ('lpae-cible-etats-gouvernements', e'cible : Etats & gouvernements', true),
    ('lpae-cible-collectivites-territoriales', e'cible : collectivités territoriales', true),
    ('lpae-cible-elus', e'cible : élus', true),
    ('lpae-cible-individus', e'cible : individus', true),
    ('lpae-cible-entreprises', e'cible : entreprises', true),
    ('lpae-cible-syndicats', e'cible : syndicats', true),
    ('lpae-cible-associations-ong', e'cible : associations & ONG', true),
    ('lpae-cible-instances-mondiales', e'cible : instances mondiales', true),
    ('lpae-action-publique', e'action : publique', true),
    ('lpae-action-des-individus', e'action : des individus', true),
    ('lpae-action-entreprises', e'action : entreprises', true),
    ('lpae-action-syndicats', e'action : syndicats', true),
    ('lpae-action-associations-ong', e'action : associations & ONG', true),
    ('lpae-action-instances-mondiales', e'action : instances mondiales', true),
    ('isolement', e'isolement', true),
    ('intergenerationnel', e'intergénérationnel', true),
    ('dialogue', e'dialogue', true),
    ('mixite-sociale', e'mixité sociale', true),
    ('sans-abri', e'sans-abri', true),
    ('civisme', e'civisme', true),
    ('sport', e'sport', true),
    ('regulation', e'régulation', true),
    ('effort-individuel', e'effort individuel', true),
    ('partage', e'partage', true),
    ('engagement-associatif', e'engagement associatif', true),
    ('numerique', e'numérique', true),
    ('ruralite', e'ruralité', true),
    ('cible-etats-gouvernements', e'cible : États & gouvernements', true),
    ('cible-collectivites-territoriales', e'cible : collectivités territoriales', true),
    ('cible-elus', e'cible : élus', true),
    ('cible-individus', e'cible : individus', true),
    ('cible-entreprises', e'cible : entreprises', true),
    ('cible-syndicats', e'cible : syndicats', true),
    ('cible-associations', e'cible : associations', true),
    ('cible-personnes-agees', e'cible : personnes âgées', true),
    ('cible-jeunes', e'cible : jeunes', true),
...
VALUES
('11111111-1111-1111-1111-111111111111','2017-09-15 08:43:30','2017-09-15 08:43:30','#adminemail#','#adminfirstname#',NULL,NULL,'#adminencryptedpassword#',true,false,'2017-09-15 08:43:30',NULL,'2017-10-15 08:43:30',NULL,NULL,'ROLE_ADMIN,ROLE_CITIZEN',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,'FR','fr')
ON CONFLICT (uuid) DO NOTHING
%
...
UPDATE operation_country_configuration SET start_date = '2018-03-08' WHERE country = 'IT' AND operation_uuid = (SELECT uuid FROM operation where slug = 'vff');
UPDATE operation_country_configuration SET start_date = '2018-03-08' WHERE country = 'GB' AND operation_uuid = (SELECT uuid FROM operation where slug = 'vff');
