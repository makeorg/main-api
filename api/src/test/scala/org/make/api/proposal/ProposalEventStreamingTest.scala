...
import org.make.api.proposal.ProposalEventStreamingTest.{
  committableOffset,
  msgCreateOk,
  msgKo,
  msgUpdateOk,
...
class ProposalEventStreamingTest
...
object ProposalEventStreamingTest extends MockitoSugar with AvroSerializers with CirceFormatters {
